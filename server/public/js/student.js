// student.js - с поддержкой всех типов вопросов
    ...
    try {
      ...
      if (user.role === "student") {
        tests = tests.filter((test) => {
          ...
          return (
            testGroups.length === 0 ||
            testGroups.some((groupId) => userGroups.includes(groupId))
          );
        });
      }
      ...
      showError(testListContainer, "Нет доступных тестов для вашей группы");
    }
  }
